...
def NN_test(nombre_de_couches_cachees=2, nombre_de_neurones_par_couche=512, taux_dapprentissage=0.2, nombre_diterations=300):
...
def test():
    list_couche_cachee = [1, 2, 3]
    list_neurones_par_couche = [512, 1024, 2048]
    list_taux_dapprentissage = [0.01, 0.02, 0.05, 0.1, 0.25]
    list_iterations = [100, 300, 500]
